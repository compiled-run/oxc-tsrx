...
| --- | --- | --- | --- |
| Native lint | 214.85 MiB/s median scan/project/parse; 64.03 MiB/s complete CLI lint; 1.199× equivalent-TSX CLI latency; 4.81 ms fresh-process p95 | 19/19 pass across three adjudication reports | [`native-lint/results-1785296504890.json`](../../benchmarks/native-lint/results-1785296504890.json) |
| Native format | 121.55 MiB/s sequential; 450.74 MiB/s default-thread p95; 18.99 MiB/s generalized control; 3.45 ms fresh-stdin p95; 1.143× complete-output RSS | 25/25 pass across three adjudication reports | [`native-format/results-1785296526997.json`](../../benchmarks/native-format/results-1785296526997.json) |
| Type-aware lint | Default syntax 2.56 ms p95 with zero type processes; one-file type-aware 28.05 ms p95; two-file project 29.65 ms p95; one type process per batch | 8/8 pass | [`type-aware/results-1785296533520.json`](../../benchmarks/type-aware/results-1785296533520.json) |
| Vite/Vite+ process boundary | Ordinary Oxfmt 119.10 ms p95 / 1.069× canonical; mixed lint 59.34 ms p95 / 1.698×; mixed format 132.80 ms p95 / 1.192×; Vite+ 0.2.4 mixed lint 254.57 ms p95; one native TSRX parse | 8/8 pass | [`vite/results-1785296550669.json`](../../benchmarks/vite/results-1785296550669.json) |
| Incremental editor | Fresh open 2.46 ms median / 2.70 ms p95 across 100 samples; diagnostics 0.128 ms p95; format 0.131 ms p95; code action 0.118 ms p95; 11.25 MiB RSS and 0 MiB growth after 1,000 edits | 8/8 pass | [`editor/results-1785296551322.json`](../../benchmarks/editor/results-1785296551322.json) |
| Matched CLI comparison | Same 1,000 explicit TSX files, one rule, every lane through its npm CLI: ESLint 648.04 ms, official Oxlint 42.03 ms, OXC for TSRX npm CLI 48.97 ms median through the zero-dispatch declared-bin route; paired 20% TSRX workload 71.05 ms / 1.451× all-TSX | All 3 assertions pass in a single unadjudicated fresh report | [`comparative/results-1785296573160.json`](../../benchmarks/comparative/results-1785296573160.json) |
