...
- **JavaScript lint plugins** do not work: OXC's own JS-plugin host lives
  behind private internal APIs, and reaching into them would break the
  no-fork upgrade contract.
