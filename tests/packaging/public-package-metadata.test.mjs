...
test("oxc-tsrx is the complete public toolchain boundary", async () => {
  ...
  assert.deepEqual(Object.entries(manifest.optionalDependencies), [
    ["@oxc-tsrx/native-darwin-arm64", "0.1.5"],
    ["@oxc-tsrx/native-darwin-x64", "0.1.5"],
    ["@oxc-tsrx/native-linux-arm64-gnu", "0.1.5"],
    ["@oxc-tsrx/native-linux-arm64-musl", "0.1.5"],
    ["@oxc-tsrx/native-linux-x64-gnu", "0.1.5"],
    ["@oxc-tsrx/native-linux-x64-musl", "0.1.5"],
    ["@oxc-tsrx/native-win32-arm64-msvc", "0.1.5"],
    ["@oxc-tsrx/native-win32-x64-msvc", "0.1.5"],
  ]);
