...
// Adapted from @tsrx/core's MIT-licensed CSS parser, Copyright (c) 2025
// Dominic Gannaway. See THIRD_PARTY_NOTICES.md for the full license notice.
function strong_hash(value) {
  return createHash("sha256")
    .update(value.replace(/\r/g, ""))
    .digest("hex")
    .slice(0, 8);
}
