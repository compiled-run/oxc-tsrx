...
export function extensionSet(extensions) {
...
export function readLspMessages(stream, onMessage, onError = (error) => {
  throw error;
}) {
...
export async function runOxlintLspMultiplexer(args, options = {}) {
