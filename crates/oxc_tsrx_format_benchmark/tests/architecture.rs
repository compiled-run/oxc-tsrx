...
#[test]
fn the_format_harness_keeps_one_concept_per_module_file() {
...
#[test]
fn no_format_harness_source_file_exceeds_the_layout_cap() {
...
#[test]
fn the_format_harness_suppresses_lints_only_with_expect() {
    for path in source_files() {
